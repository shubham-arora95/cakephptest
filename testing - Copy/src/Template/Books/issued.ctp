          ...
          <div class="box box-primary">
            ...
            <div class="box-footer">
                <?php if($transaction->status == 0): ?>
                    ...
                    <?= $this->Html->link(__('Verify Code'), ['controller' => 'transactions', 'action' => 'verifyCode', $transaction->id], ['class' => 'btn btn-block btn-primary']) ?>
                ...
                <?php elseif($transaction->status == 2): ?>
                    ...
                    <?= $this->Html->link(__('Confirm Return'), ['controller' => 'transactions', 'action' => 'confirmReturn', $transaction->id], ['class' => 'btn btn-block btn-primary']) ?>
